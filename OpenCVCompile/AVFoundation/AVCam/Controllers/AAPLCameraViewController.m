...
@interface AAPLCameraViewController () <UINavigationControllerDelegate, UIImagePickerControllerDelegate>
...
- (void)viewDidLoad
{
    ...
    self.manualHUDAiIntelligenceView.hidden = YES;
    ...
    if ([self.session canSetSessionPreset:AVCaptureSessionPreset1280x720]) {
        ...
        // Kiandr: How to manage the Video resolution:
        // Handle the failure. Set to VGA resolution for more info look at :
        // https://developer.apple.com/library/ios/documentation/AudioVideo/Conceptual/AVFoundationPG/Articles/04_MediaCapture.html#//apple_ref/doc/uid/TP40010188-CH5-SW14
